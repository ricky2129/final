...
import { ConfigureDriftAssist } from "components/ConfigureDriftAssist";
import { ConfigureDashboardAssist } from "components/ConfigureDashboardAssist";
...
=======
  ...
  const [isDashboardAssistDrawerOpen, setIsDashboardAssistDrawerOpen] = useState<boolean>(false);
  const [configureDashboardAssistForm] = Form.useForm();
>>>>>>> f0ce0ac (das)
...
=======
    } else if (serviceName === "DashboardAssist") {
      configureDashboardAssistForm.resetFields();
      setIsDashboardAssistDrawerOpen(true);
    }
  };
...
=======
      ...
      <Drawer
        title="Configure Drift Assist Connection"
        open={isDriftAssistDrawerOpen}
        onClose={() => setIsDriftAssistDrawerOpen(false)}
        onCancel={() => setIsDriftAssistDrawerOpen(false)}
        disabled={disabledSave}
      ...
      <Drawer
        title="Configure Dashboard Assist Connection"
        open={isDashboardAssistDrawerOpen}
        onClose={() => setIsDashboardAssistDrawerOpen(false)}
        onCancel={() => setIsDashboardAssistDrawerOpen(false)}
        disabled={disabledSave}
        loading={isLoading}
        hideFooter={true}
      >
        <ConfigureDashboardAssist
          setDisabledSave={setDisabledSave}
          configureDashboardAssistForm={configureDashboardAssistForm}
          onFinish={() => setIsDashboardAssistDrawerOpen(false)}
        />
      </Drawer>

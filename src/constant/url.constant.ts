...
<<<<<<< HEAD
=======
  UPDATE_APPLICATION: "/application/update/:application_id",
>>>>>>> f0ce0ac (das)
...
<<<<<<< HEAD
=======
  DELETE_INTEGRATION: "/integration/integrations/:integration_id",
>>>>>>> f0ce0ac (das)
...
=======
    // SLO-SLI URLs
  SETUP: "/slo/setup",
  GET_APPLICATION_SLO: "/slo/get_application_slo",
  GET_PROJECT_SLO: "/slo/get_project_slo",
  GET_PROJECT_APPLICATION_SLO: "/slo/project_slo/:project_slo_id/application_slo",
  GENERATE_GRAFANA_PANEL_URL: "/slo/generate_grafana_panel_url",
  CREATE_APPLICATION_SLO: "/slo/application_slo",
  CREATE_PROJECT_SLO: "/slo/project_slo",
  GENERATE_PROMETHEUS_RULES: "/slo/generate_prometheus_rules",
  GENERATE_DASHBOARD: "/slo/generate_dashboard",
  WEBHOOK: "/slo/webhook",
};
...
export const TraceAssistUrl = {
  ...
  // INSTRUMENT_DEPLOYMENT: `${TRACE_ASSIST_BASE_URL}/deployments/:deployment_name/instrument`,
  GET_ALL_DEPLOYMENTS: `${TRACE_ASSIST_BASE_URL}/deployments`,
   INSTRUMENT_DEPLOYMENT: `${TRACE_ASSIST_BASE_URL}/instrument`,
   SETUP_OTEL_COMPONETS: `${TRACE_ASSIST_BASE_URL}/setup/otel-components`,
  // ANALYZE_REPO: `${TRACE_ASSIST_BASE_URL}/deployments/analyze`,
  // DELETE_DEPLOYMENT: `${TRACE_ASSIST_BASE_URL}/deployments/:deployment_name`
>>>>>>> f0ce0ac (das)
};
...
<<<<<<< HEAD
=======
  INJECT_FAULT_DISK: `${TOIL_ASSIST_BASE_URL}/inject-fault/disk`
>>>>>>> f0ce0ac (das)
};
...
<<<<<<< HEAD
=======
  DISCOVER_DEPLOYMENTS: `${DASHBOARD_ASSIST_BASE_URL}/discover`,
  DELETE_DASHBOARD: `${DASHBOARD_ASSIST_BASE_URL}/delete_dashboard`
>>>>>>> f0ce0ac (das)
};

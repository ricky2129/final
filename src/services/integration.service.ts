...
=======
import { get, post, put, delete_ as del } from "network/query";
>>>>>>> f0ce0ac (das)
...
=======
const deleteIntegration = async (integration_id: string): Promise<void> => {
    await del(resolveUrlParams(ApiUrl.DELETE_INTEGRATION, { integration_id }));
  };
